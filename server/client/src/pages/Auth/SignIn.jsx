...
import signupBg from "../../assets/signeupbg.png";
  ...
  return (
    <div className="h-screen overflow-hidden relative bg-cyan-50">
      <div className="container h-screen px-30 mx-auto flex items-center justify-center">
        {/* Left image */}
        <div
      className="w-1/3 flex flex-col items-start justify-end h-[70vh] border-purple-400 rounded-xl p-10 z-50 shadow-xl shadow-purple-400"
      style={{
